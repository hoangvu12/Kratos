//! roboco-rpc — the typed control plane (UiRpc / ControlRpc) over WebSocket + in-memory
...
//! byte transports), matching the shape of roboco's Effect RPC without the Effect runtime:
//!
...
pub mod methods {
    ...
    /// In-flight queued-attachment transfers (`roboco_proto::TransferProgress`
