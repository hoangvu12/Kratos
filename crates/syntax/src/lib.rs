//! Syntax-highlighting contracts shared by Roboco's desktop surfaces.
//!
...
fn rust_configuration() -> Result<HighlightConfiguration, HighlightError> {
    ...
    // `constant.builtin`. Roboco preserves those structural roles separately.
