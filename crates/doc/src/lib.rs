//! roboco-doc — session & workspace Loro doc schemas and the typed mirror layer.
//!
//! Port of roboco's `packages/session-doc`. The schema SHAPE (container names, part maps with
...
//!
//! Load-bearing invariant (measured in roboco, `oplog-shape.test.ts`): message parts are a
