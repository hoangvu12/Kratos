#!/bin/sh
# Fake ACP agent for roboco-harness tests.
#
...
*scenario:prompt-complete-stale*)
  ...
  emit "{\"method\":\"_x.ai/session/prompt_complete\",\"params\":{\"sessionId\":\"other\",\"promptId\":\"roboco-p1\",\"stopReason\":\"cancelled\",\"agentResult\":null}}"
  sleep 1
...
*scenario:happy*)
  ...
  update '{"sessionUpdate":"tool_call","toolCallId":"t1","title":"cargo test -p roboco-harness","kind":"execute","status":"pending","rawInput":{"command":"cargo test -p roboco-harness"}}'
  update '{"sessionUpdate":"tool_call_update","toolCallId":"t1","status":"completed","content":[{"type":"content","content":{"type":"text","text":"   Compiling roboco-harness v0.1.21\n    Finished `dev` profile [unoptimized] in 2.41s\n     Running tests/acp.rs\n\nrunning 13 tests\ntest result: ok. 13 passed; 0 failed; 0 ignored"}}]}'
