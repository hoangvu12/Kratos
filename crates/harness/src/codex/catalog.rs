//! Model catalog + effort mapping for Codex, ported from roboco's
...
use roboco_proto::{Model, ModelOption, ModelOptionChoice, ReasoningLevel, SandboxLevel};
...
/// access: roboco agents fetch deps and hit APIs unattended, and with the
