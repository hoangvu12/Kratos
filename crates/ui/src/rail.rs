...
use roboco_doc::{MessagePart, MessageRole, SessionMessageEntry};
...
/// `ROBOCO_SCROLL_TRACE=1` logs per-frame glide positions at `warn` level —
/// the smoothness measurement knob (same family as `ROBOCO_FRAME_STATS`).
