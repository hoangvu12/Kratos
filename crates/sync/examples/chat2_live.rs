...
//!
//! Usage:
//!   cargo run -p roboco-sync --example chat2_live -- <baseUrl> <chatId> <token> <device>
//!
...
use roboco_sync::SyncError;
use roboco_sync::chat_client::{ChatClient, ChatDocSink, CheckpointFetcher, RowImportOutcome};
