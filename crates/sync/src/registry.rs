...
//! [`roboco_doc::RegistryDoc`] under a lock. Wire frames are JSON text —
...
use roboco_doc::{PendingBatch, RegistryDoc, RegistryRow, StateOutcome};
...
// ── stats (RoomStatsSnapshot-compatible so SyncStatus/`roboco sync` render it) ─
