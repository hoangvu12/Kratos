...
the shortcut while another application is focused. Invoking it inside Roboco is
...
`cargo build -p roboco-ui --example appshots-fixture --features appshots-fixture`.
