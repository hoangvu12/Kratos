...
A standalone reproduction isolates the mechanism without Roboco, a window,
...
Roboco's rendering uses these command types. Reducing unnecessary submissions
...
ROBOCO_PROFILE_PROMPT='Replay fixture.' ROBOCO_PROFILE_IDLE_MS=10000 \
ROBOCO_FRAME_STATS=0 node scripts/resource-profile.mjs \
  /path/to/immutable/roboco /tmp/fresh-replay-profile claude-code
```
