...
| Command | Result |
| --- | --- |
| `cargo test --release --locked -p roboco-ui --lib -- --test-threads=1` | 762 passed |
| `cargo test --release --locked -p roboco-engine --lib` | 161 passed |
| `cargo test --release --locked -p roboco-proto -p roboco-rpc` | 47 passed, 1 previously ignored |
| `cargo test --release --locked -p roboco-engine --test workspace_files` | 3 passed |
| `cargo test --release --locked -p roboco-engine --test device_routing workspace_file_surface_proxies_over_the_relay` | 1 passed |
| `cargo check --locked -p roboco` | Passed |
