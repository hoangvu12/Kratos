...
export ROBOCO_BROWSER_NATIVE_POINTER=1
...
record_fixture x11
export WAYLAND_DISPLAY=roboco-browser-test GDK_BACKEND=wayland
...
export ROBOCO_BROWSER_CAPTURE_WINDOW="$(xdotool search --class weston | head -1)"
record_fixture wayland "$ROBOCO_BROWSER_CAPTURE_WINDOW"
