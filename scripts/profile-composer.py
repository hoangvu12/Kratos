...
env = os.environ | {'DISPLAY': args.display, 'WAYLAND_DISPLAY': '', 'ROBOCO_IPC_PORT': args.ipc_port, 'ROBOCO_HARNESS': 'mock', 'ROBOCO_DATA_DIR': str(out), 'RUST_LOG': 'warn', 'LP_NUM_THREADS': '4'}
