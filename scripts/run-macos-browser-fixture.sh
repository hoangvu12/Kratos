...
BINARY="$1"
shift
BUNDLE="$(mktemp -d "${TMPDIR:-/tmp}/roboco-browser-fixture.XXXXXX")/Fixture.app"
...
/usr/libexec/PlistBuddy -c 'Set :CFBundleIdentifier sh.roboco.browser-fixture' "$BUNDLE/Contents/Info.plist"
